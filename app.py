...
# db.create_all() only need to create once, if we do it a second time, it will override our data
...
video_update_args.add_argument("views", type=int, help="Video view count")
video_update_args.add_argument("likes", type=int, help="Video likes count")
